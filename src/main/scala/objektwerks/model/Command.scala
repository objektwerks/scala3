...
final case class ListHeaterSettings(license: String, heaterId: Int) extends Command
...
final case class ListChemicals(license: String, poolId: Int) extends Command
